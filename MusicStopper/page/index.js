...
const App = () => {
  let [enable, setEnable] = createSignal(localStorage.getItem('cuber_musicstopper_enable', false));
  return (() => {
    ...
    setProp(_el$3, "text", enable);
    effect(_$p => setProp(_el$, "p", EdgeInsets.all(px$1(60)), _$p));
    return _el$;
  })();
};
